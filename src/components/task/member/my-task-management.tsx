...
console.log("User email in MyTasksManagement:", email);
  useEffect(() => {
    setMounted(true)
  ...
  return (
    <div className="bg-slate-900 min-h-screen">
      ...
      <div className="bg-slate-800 border-b border-slate-700 p-4 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-400 mt-1">View and manage your assigned tasks</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-slate-900 py-6">
        {email ? <MyTasksList filter={filter} email={email} /> : <p className="text-center text-gray-400">Loading...</p>}
      </div>
    </div>
  )
}
